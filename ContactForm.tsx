...
export default function ContactForm() {
  ...
  const fieldClass =
    "mt-2 w-full border border-line bg-panel-2 px-3.5 py-2.5 text-[15px] text-ink placeholder:text-muted transition-colors focus:border-signal";
    ...
    <form onSubmit={onSubmit} noValidate className="space-y-5">
      ...
      {sent ? (
        <p role="status" className="text-sm text-signal">
          ...
          send. If it did not, email us directly at{" "}
          <a
